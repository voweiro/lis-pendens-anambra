    ...
    <div className="p-6">
      ...
      <div className="mt-8 bg-white rounded-lg p-6 shadow-sm">
        ...
        <div className="mt-4 text-center">
          <p className="text-gray-700">
            Total record uploads in 6 months: <span className="font-semibold">23465 searches</span>
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm md:col-span-2">
          ...
          <div className="mt-4 text-center">
            <p className="text-gray-700">
              Total searches in 6 months: <span className="font-semibold">23465 searches</span>
            </p>
          </div>
        </div>
      </div>
