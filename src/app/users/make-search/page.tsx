...
const MakeSearchPage = () => {
  ...
  const handleViewResults = async () => {
    ...
    try {
      ...
      const authToken = auth?.accessToken || (sessionStorage.getItem('auth') ? JSON.parse(sessionStorage.getItem('auth') || '{}').accessToken : null);
      ...
      if (!paymentInfo) {
        toast.error("Payment information not found. Please complete payment first.");
        router.push("/users/dashboard");
        return;
      }
