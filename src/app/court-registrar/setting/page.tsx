...
import { UpdateCourtRegistrarSettings, DeleteAccountRequest } from '@/Services/AuthRequest/auth.request';
    ...
    try {
      ...
      if (authStr) {
        ...
        if (auth.data) {
          ...
          setCourtinfo(auth.data.court_info || 'Court 3 of the Awka Judiciary Division');
          setCourtnumber(auth.data.court_number || 'i123456YUGDSFF');
          setJudicialdivision(auth.data.judicial_division || 'Awka Judicial Division');
          ...
          if (userStr) {
            ...
            setCourtinfo(userData.court_info || 'Court 3 of the Awka Judiciary Division');
            setCourtnumber(userData.court_number || 'i123456YUGDSFF');
            setJudicialdivision(userData.judicial_division || 'Awka Judicial Division');
