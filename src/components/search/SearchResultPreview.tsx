...
const SearchResultPreview: React.FC<SearchResultPreviewProps> = ({ results, onGetAccess, relatedSearches }) => {
  return (
    <div className="flex flex-col items-center justify-center">
      <div
        className="bg-[#f5f6fa] rounded-[24px] border border-gray-200 w-full max-w-[1084px] h-[690px] mt-[104px] ml-[96px] shadow-md p-0"
      >
        {/* Summary bar */}
