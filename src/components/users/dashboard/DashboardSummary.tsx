    ...
    <>
      ...
      >
        ...
        <div className="block md:hidden space-y-4">
          {/* Welcome Section */}
          <div className="bg-[#00AD20] text-white rounded-[30px] p-6 relative overflow-hidden">
            <div className="mb-6">
            ...
            <div className="flex justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="bg-white text-[#00AD20] p-2 rounded-full flex-shrink-0">
                  <Home size={24} />
                </div>
                <div>
          ...
          <div className="bg-[#23A863] text-white rounded-[30px] p-6 text-center">
        ...
        <div className="hidden lg:flex gap-6">
          {/* Welcome Section */}
          <div className="flex-1 bg-[#00AD20] text-white rounded-[30px] p-8 relative overflow-hidden min-h-[280px]">
            ...
            <div className="absolute top-1/2 right-8 -translate-y-1/2 flex flex-col gap-6">
              <div className="flex items-center gap-3">
                <div className="bg-white text-[#00AD20] p-2.5 rounded-full">
                  <Home size={32} />
                </div>
                <div>
          ...
          {/* Amount Spent Section */}
          <div className="w-[280px] bg-[#23A863] text-white rounded-[30px] p-8 flex flex-col justify-center text-center">
